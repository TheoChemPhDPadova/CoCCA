...
PARSER.add_argument("--CN", help="Atom number(s) to constrain separed by a comma")
...
if SOFT == "1":
    ...
    print("\nTo freeze atoms in hessian calculation (All immaginary mode due to frozen atoms will be projected out) use\n")
    print("$fix")
    for i in CONST_INDEX:
        print("atoms: ", i)
        print("freeze:", i)
